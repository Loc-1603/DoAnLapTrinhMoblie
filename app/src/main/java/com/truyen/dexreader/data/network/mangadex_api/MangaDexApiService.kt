package com.truyen.dexreader.data.network.mangadex_api

import com.truyen.dexreader.data.network.mangadex_api.dto.AtHomeServerDto
import com.truyen.dexreader.data.network.mangadex_api.response.ChapterDetailsResponse
import com.truyen.dexreader.data.network.mangadex_api.response.ChapterListResponse
import com.truyen.dexreader.data.network.mangadex_api.response.MangaDetailsResponse
import com.truyen.dexreader.data.network.mangadex_api.response.MangaListResponse
import com.truyen.dexreader.data.network.mangadex_api.response.TagListResponse
